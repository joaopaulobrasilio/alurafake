...
class UserRepositoryTest {
    ...
    void findByEmail__should_return_existis_user() {
        User caio = new User("Andre", "andre@alura.com.br", Role.STUDENT);
        userRepository.save(caio);

        Optional<User> result = userRepository.findByEmail("andre@alura.com.br");
        assertThat(result).isPresent();
        assertThat(result.get().getName()).isEqualTo("Andre");
